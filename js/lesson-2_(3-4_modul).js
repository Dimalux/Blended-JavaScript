...
// Завдання 11 (Урок 2 / Модуль 4):   Коли масив складається з складних типів данних (коли при ...spread операторі йде НЕГЛИБОКЕ копіювання). Тобто при копіюванні об'єктів і масивів (складних типів данних) копіюються не самі елементи, а ПОСИЛАННЯ на них:
...
// ВАРІАНТ 3 -   КЛАДНИЙ тип данних МАСИВ:
...
// num1[0][0] = 100;  // в масиві "num1" йдем за посиланням і змінюємо перший елемент масиву в комірці пам'яті. Один масив [100, 2, 3] на два посилання в масивах "num1" і "num2":
